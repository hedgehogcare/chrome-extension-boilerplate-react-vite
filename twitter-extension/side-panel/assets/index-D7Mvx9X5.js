...
function ty() {
  ...
  function jl(o, A, V, Q, N) {
    ...
    I = 0;
    var Jl = Q === '' ? '.' : Q + ':';
    if (yl(o)) for (var dl = 0; dl < o.length; dl++) (Q = o[dl]), (cl = Jl + il(Q, dl)), (I += jl(Q, A, V, cl, N));
    else if (((dl = W(o)), typeof dl == 'function'))
      for (o = dl.call(o), dl = 0; !(Q = o.next()).done; )
        (Q = Q.value), (cl = Jl + il(Q, dl++)), (I += jl(Q, A, V, cl, N));
    else if (cl === 'object') {
...
` +
  ...
  function Gd(l, t, e, a, u, n) {
    ...
    a !== 0 && zf(l, a, 0), n !== 0 && u === 0 && l.tag !== 0 && (l.suspendedLanes |= n & ~(i & ~t));
  }
  function zf(l, t, e) {
  ...
  var te = Math.random().toString(36).slice(2),
    ...
    Ca = '__reactMarker$' + te;
  function ai(l) {
    delete l[Ll], delete l[Pl], delete l[ei], delete l[Xd], delete l[Qd];
  }
  function Me(l) {
    var t = l[Ll];
    if (t) return t;
  ...
  function Pf(l) {
    ...
    return t === 'input' ? !!Ah[l.type] : t === 'textarea';
  }
  function If(l, t, e, a) {
  ...
  function an(l) {
    var t = Fa;
    return (Fa += 1), ra === null && (ra = []), zr(ra, l, t);
  }
  function Pa(l, t) {
  ...
  function Kh(l, t, e) {
    ...
    (e = { lane: a, revertLane: 0, action: e, hasEagerState: !1, eagerState: null, next: null }),
      mn(l) ? hs(t, e) : ((e = zi(l, t, e, a)), e !== null && (kl(e, l, a), ys(e, t, a)));
  }
  function ds(l, t, e) {
    var a = rt();
    au(l, t, e, a);
  ...
  function au(l, t, e, a) {
    ...
    if (mn(l)) hs(t, u);
      ...
      if (((e = zi(l, t, u, a)), e !== null)) return kl(e, l, a), ys(e, t, a), !0;
    }
    return !1;
  }
  function ki(l, t, e, a) {
    ...
    } else (t = zi(l, e, a, 2)), t !== null && kl(t, l, 2);
  }
  function mn(l) {
    var t = l.alternate;
  ...
  var Be = {
    ...
    useTransition: function () {
      var l = Zi(!1);
      return (l = cs.bind(null, ll, l.queue, !0, !1)), (lt().memoizedState = l), [!1, l];
    },
    ...
    useCacheRefresh: function () {
      return (lt().memoizedState = wh.bind(null, ll));
    },
  };
  (Be.useMemoCache = ji),
      ...
      if (n)
        ...
        if (((i = bl), i !== null)) {
          ...
          if (((a = a & (i.suspendedLanes | e) ? 0 : a), a !== 0 && a !== f.retryLane))
            throw ((f.retryLane = a), ae(l, a), kl(i, l, a), As);
        }
  ...
  function Cs(l, t, e) {
    ...
    switch (((t.lanes = 0), t.tag)) {
      ...
      case 5:
        return (
          l === null &&
            sl &&
            ((u = a = Xl) &&
              ((a = z0(a, t.type, t.pendingProps, Ut)),
          ...
          t.memoizedState !== null && ((u = Ci(l, t, Qh, null, null, e)), (Au._currentValue = u)),
          uu(l, t),
          Ql(l, t, a, e),
          t.child
        );
      ...
      case 11:
        return zs(l, t, t.type, t.pendingProps, e);
      case 7:
  ...
  function Ws(l, t, e) {
    ...
    switch (e.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        zl || (it(e, t), (a = e.stateNode), typeof a.componentWillUnmount == 'function' && Xs(e, t, a)), wt(l, t, e);
        break;
      case 21:
        wt(l, t, e);
        break;
  ...
  function zn(l, t) {
    t !== null && (l.flags |= 4), l.flags & 16384 && ((t = l.tag !== 22 ? Af() : 536870912), (l.lanes |= t), (pa |= t));
  }
  function hu(l, t) {
    if (!sl)
      switch (l.tailMode) {
  ...
  function ro(l, t, e, a, u, n, i, c, f, h, E, z, m) {
    var S = t.subtreeFlags;
    if (
      (S & 8192 || (S & 16785408) === 16785408) &&
      ((Tu = { stylesheets: null, count: 0, unsuspend: B0 }), Is(t), (t = j0()), t !== null)
    ) {
      (l.cancelPendingCommit = t(go.bind(null, l, e, a, u, i, c, f, 1, z, m))), $t(l, n, i, !h);
      return;
    }
    go(l, e, a, u, i, c, f, E, z, m);
  }
  function e0(l) {
    for (var t = l; ; ) {
      var e = t.tag;
  ...
  function so(l, t) {
    (ll = null),
      ...
      t === ka
        ...
        : t === Tr
          ? ((t = Or()), (Sl = 4))
          : (Sl = t === As ? 8 : t !== null && typeof t == 'object' && typeof t.then == 'function' ? 6 : 1),
      (ft = t),
        ...
        if (Sl !== 0 && el !== null) {
          ...
          t: switch (Sl) {
            ...
            case 4:
              ...
              break l;
            case 7:
              Ar(n) ? ((Sl = 0), (ft = null), vo(t)) : ((Sl = 0), (ft = null), Ta(l, t, n, 7));
              break;
            case 5:
              var i = null;
              switch (el.tag) {
  ...
  function go(l, t, e, a, u, n, i, c, f, h) {
    var E = j.T,
      z = N.p;
    try {
      (N.p = 2), (j.T = null), i0(l, t, e, a, z, u, n, i, c, f, h);
    } finally {
      (j.T = E), (N.p = z);
    }
  }
  ...
  function Cc(l, t, e) {
    ...
    u.has(e) || ((zc = !0), u.add(e), (l = c0.bind(null, l, t, e)), t.then(l, l));
  }
  function c0(l, t, e) {
    var a = l.pingCache;
    a !== null && a.delete(t),
  ...
  function po(l, t) {
    t === 0 && (t = Af()), (l = ae(l, t)), l !== null && (qa(l, t), qt(l));
  }
  function f0(l) {
    var t = l.memoizedState,
      e = 0;
      ...
      do
        for (var e = !1, a = Un; a !== null; ) {
          if (l !== 0) {
            ...
            n !== 0 && ((e = !0), Ao(a, n));
          } else (n = fl), (n = ju(a, a === bl ? n : 0)), !(n & 3) || Na(a, n) || ((e = !0), Ao(a, n));
          a = a.next;
        }
      while (e);
      Bc = !1;
  ...
  function h0(l, t, e, a, u) {
    if (t === 'submit' && e && e.stateNode === u) {
      var n = zo((u[Pl] || null).action),
        i = a.submitter;
      i &&
        ((t = (t = i[Pl] || null) ? zo(t.formAction) : i.getAttribute('formAction')),
        t !== null && ((n = t), (i = null)));
  ...
  zt(or, 'onAnimationEnd'),
    zt(dr, 'onAnimationIteration'),
    zt(hr, 'onAnimationStart'),
    zt('dblclick', 'onDoubleClick'),
    zt('focusin', 'onFocus'),
    zt('focusout', 'onBlur'),
    zt(Hh, 'onTransitionRun'),
    zt(Nh, 'onTransitionStart'),
    zt(qh, 'onTransitionCancel'),
    zt(yr, 'onTransitionEnd'),
      ...
      if (!(t & 7)) {
        l: {
          ...
          if (
            ...
            S !== null && Do(z, m, S, K, !1), C !== null && Ml !== null && Do(z, Ml, C, K, !0);
          }
        }
        l: {
          if (
...
`,
  ...
  var No = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    T0 =
      typeof queueMicrotask == 'function'
        ...
        : typeof qo < 'u'
          ? function (l) {
              return qo.resolve(null).then(l).catch(A0);
            }
          : No;
  function A0(l) {
    setTimeout(function () {
  ...
  function wo(l, t, e, a, u, n, i, c, f, h, E, z) {
    return (
      (l = new Q0(l, t, e, i, c, f, h, z)),
      (t = 1),
      n === !0 && (t |= 24),
      (n = St(3, null, null, t)),
      (l.current = n),
    ...
    (Kn.prototype.unmount = nf.prototype.unmount =
      function () {
        ...
        if (l !== null) {
          ...
          l.tag === 0 && Aa(), Jo(l.current, 2, null, l, null, null), Dn(), (t[We] = null);
        }
      });
  function Kn(l) {
    this._internalRoot = l;
...
function fy(r, b) {
  return function (s) {
    return $l.jsx(kn.Suspense, { fallback: b, children: $l.jsx(r, { ...s }) });
  };
}
...
function sy(r, b) {
  return function (s) {
    return $l.jsx(ry, { fallback: b, children: $l.jsx(r, { ...s }) });
  };
}
var Hu;
(function (r) {
...
function oy(r, b, g) {
  ...
  const p = async () => {
    ...
    J = async O => {
      M || (s = await p()), (s = await hd(O, s)), await (tt == null ? void 0 : tt.storage[x].set({ [r]: U(s) })), B();
    },
    W = O => (
      (_ = [..._, O]),
      () => {
...
function zy() {
  let r = 0,
    ...
    g,
    s = '';
  for (; r < arguments.length; ) (b = arguments[r++]) && (g = zd(b)) && (s && (s += ' '), (s += g));
  return s;
}
const zd = r => {
  ...
  let b,
    g = '';
  for (let s = 0; s < r.length; s++) r[s] && (b = zd(r[s])) && (g && (g += ' '), (g += b));
  return g;
};
function Oy(r, ...b) {
  let g,
  ...
  return function () {
    return _(zy.apply(null, arguments));
  };
}
const pl = r => {
    const b = g => g[r] || [];
  ...
  Vy = () => {
    ...
    return {
      ...
      theme: {
        ...
        gradientColorStopPositions: [Ny, Ae],
        inset: Vl(),
        margin: Vl(),
        opacity: A(),
        padding: il(),
      ...
      classGroups: {
        ...
        shadow: [{ shadow: ['', 'inner', 'none', ze, jy] }],
...
const Wy = (r, b) => chrome.i18n.getMessage(r, b),
  ...
  $y = () => {
    const b = pd($n) === 'light',
      g = b ? 'side-panel/logo_vertical.svg' : 'side-panel/logo_vertical_dark.svg',
    ...
    return $l.jsx('div', {
      ...
      children: $l.jsxs('header', {
        ...
        children: [
          $l.jsx('button', {
            onClick: s,
            children: $l.jsx('img', { src: chrome.runtime.getURL(g), className: 'App-logo', alt: 'logo' }),
          }),
          $l.jsxs('p', { children: ['Edit ', $l.jsx('code', { children: 'pages/side-panel/src/SidePanel.tsx' })] }),
          $l.jsx(Ky, { onClick: $n.toggle, children: ky('toggleTheme') }),
        ],
      }),
    });
  },
  Fy = sy(fy($y, $l.jsx('div', { children: ' Loading ... ' })), $l.jsx('div', { children: ' Error Occur ' }));
function Py() {
  const r = document.querySelector('#app-container');
  if (!r) throw new Error('Can not find #app-container');
  iy.createRoot(r).render($l.jsx(Fy, {}));
}
Py();
